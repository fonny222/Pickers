...
class CustomPickerViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func playWinSound(){
        if winSoundID == 0{
            ...
            // the book wants Bundle.main.urlForResource() this is wrong for swift 3
            // what I wrote is the correct way for swift 3
        ...
        // book wanted DispatchQueue.main.after(when: .now() + 1.5) this is wrong for swift 3
        // I found the correct way to do it here
